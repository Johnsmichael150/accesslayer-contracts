...
use contract_test_env::{
    compute_expected_sell_price, register_creator_keys, register_test_creator, set_pricing_and_fees,
    test_env_with_auths,
};
...
fn assert_sell_quote(
    ...
    assert_eq!(q.price, compute_expected_sell_price(supply, key_price), "price");
